...
public class SliderScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (slider.value == 1)
        {
            descriptionText.text = "This group has a FAL of 1.2 - very low activity (sedentary or no physical activity).";
        ...
        {
            descriptionText.text = "FAL is 1.375 - low activity 1 to 3 times a week.";
        ...
        {
            descriptionText.text = "FAL is 1.55 - average activity 3 to 5 times a week.";
        ...
        {
            descriptionText.text = "FAL is 1.725 - high activity 6 to 7 times a week.";
